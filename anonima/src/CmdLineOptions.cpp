...
namespace xmreg
{
    ...
    CmdLineOptions::CmdLineOptions(int acc, const char *avv[]) {
        ...
        options_description desc(
                "anonima, Onion Monero Blockchain Explorer");
        ...
        desc.add_options()
                ...
                ("enable-pusher", value<bool>()->default_value(false)->implicit_value(true),
                 ...
                 ("enable-swaps", value<bool>()->default_value(false)->implicit_value(true),
                 "enable atomic swaps integrations")
                ...
                ("bindaddr,x", value<string>()->default_value("0.0.0.0"),
                 "default bind address for the board")
                 ("rendezvous-point", value<string>()->default_value("/dnsaddr/swap.sethforprivacy.com/p2p/12D3KooWCULyZKuV9YEkb6BX8FuwajdvktSzmMg4U5ZX2uYZjHeu"),
                 "specify the rendezous-point for comit-network atomic swaps")
                ("testnet-url", value<string>()->default_value(""),
                 "you can specify testnet url, if you run it on mainnet or stagenet. link will show on front page to testnet board")
                ("stagenet-url", value<string>()->default_value(""),
                 "you can specify stagenet url, if you run it on mainnet or testnet. link will show on front page to stagenet board")
                ("mainnet-url", value<string>()->default_value(""),
                 "you can specify mainnet url, if you run it on testnet or stagenet. link will show on front page to mainnet board")
