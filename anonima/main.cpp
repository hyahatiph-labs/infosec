...
main(int ac, const char* av[])
{
    ...
    auto rendezvous_point              = opts.get_option<string>("rendezvous-point");
    ...
    auto enable_swaps_opt              = opts.get_option<bool>("enable-swaps");
    ...
    bool enable_swaps                 {*enable_swaps_opt};
    ...
    if (enable_emission_monitor == true)
    {
        ...
        // from scrach whenever the board is started,
    ...
    CROW_ROUTE(app, "/")
    ([&]() {
        return myxmr::htmlresponse(anonima.index2());
    });

    CROW_ROUTE(app, "/page/<uint>")
    ([&](size_t page_no) {
        return myxmr::htmlresponse(anonima.index2(page_no));
    });

    CROW_ROUTE(app, "/block/<uint>")
    ([&](size_t block_height) {
        return myxmr::htmlresponse(anonima.show_block(block_height));
    });
    
    CROW_ROUTE(app, "/randomx/<uint>")
    ([&](size_t block_height) {
        return myxmr::htmlresponse(anonima.show_randomx(block_height));
    });

    CROW_ROUTE(app, "/block/<string>")
    ([&](string block_hash) {
        return myxmr::htmlresponse(
                anonima.show_block(remove_bad_chars(block_hash)));
    });

    CROW_ROUTE(app, "/tx/<string>")
    ([&](string tx_hash) {
        return myxmr::htmlresponse(
                anonima.show_tx(remove_bad_chars(tx_hash)));
    });
    if (enable_autorefresh_option)
    {
        ...
        ([&](string tx_hash) {
            ...
            return myxmr::htmlresponse(
                anonima.show_tx(remove_bad_chars(tx_hash), with_ring_signatures, refresh_page));
        });
    }
    ...
    if (enable_as_hex)
    {
        ...
        ([&](string tx_hash) {
            return crow::response(
                    anonima.show_tx_hex(remove_bad_chars(tx_hash)));
        });

        CROW_ROUTE(app, "/ringmembershex/<string>")
        ([&](string tx_hash) {
            return crow::response(
                    anonima.show_ringmembers_hex(remove_bad_chars(tx_hash)));
        });

        CROW_ROUTE(app, "/blockhex/<uint>")
        ([&](size_t block_height) {
            return crow::response(
                    anonima.show_block_hex(block_height, false));
        });

        CROW_ROUTE(app, "/blockhexcomplete/<uint>")
        ([&](size_t block_height) {
            return crow::response(
                    anonima.show_block_hex(block_height, true));
        });

//        CROW_ROUTE(app, "/ringmemberstxhex/<string>")
//        ([&](string tx_hash) {
//            return crow::response(
//              anonima.show_ringmemberstx_hex(remove_bad_chars(tx_hash)));
//        });

        CROW_ROUTE(app, "/ringmemberstxhex/<string>")
        ([&](string tx_hash) {
            return myxmr::jsonresponse {
                anonima.show_ringmemberstx_jsonhex(
    ...
    if (enable_autorefresh_option)
    {
        ...
        ([&](string tx_hash, uint16_t with_ring_signature) {
            bool refresh_page {true};
            return myxmr::htmlresponse(
                anonima.show_tx(remove_bad_chars(tx_hash), with_ring_signature, refresh_page));
        });
    }
    ...
    ([&](const crow::request& req) -> myxmr::htmlresponse
     {
        ...
        string response = anonima.show_my_outputs(
                                         tx_hash, xmr_address,
                                         viewkey, raw_tx_data,
                                         domain);
    ...
    ([&](const crow::request& req, string tx_hash,
        string xmr_address, string viewkey)
     {
        ...
        return myxmr::htmlresponse(anonima.show_my_outputs(
                                         remove_bad_chars(tx_hash),
        ...
        ([&](const crow::request& req) -> myxmr::htmlresponse 
         {
            ...
            return myxmr::htmlresponse(anonima.show_prove(tx_hash,
                                        xmr_address,
                                        tx_prv_key,
                                        raw_tx_data,
                                        domain));
    ...
    ([&](const crow::request& req, string tx_hash,
         string xmr_address, string tx_prv_key) 
     {
        ...
        return myxmr::htmlresponse(anonima.show_prove(
                                    remove_bad_chars(tx_hash),
                                    remove_bad_chars(xmr_address),
    ...
    if (enable_pusher)
    {
        ...
        ([&]() {
            return myxmr::htmlresponse(anonima.show_rawtx());
        });
        ...
        ([&](const crow::request& req) -> myxmr::htmlresponse
         {
            ...
            if (action == "check")
                return myxmr::htmlresponse(
                        anonima.show_checkrawtx(raw_tx_data, action));
            else if (action == "push")
                return myxmr::htmlresponse(
                        anonima.show_pushrawtx(raw_tx_data, action));
    ...
    if (enable_key_image_checker)
    {
        ...
        ([&]() {
            return myxmr::htmlresponse(anonima.show_rawkeyimgs());
        });
        ...
        ([&](const crow::request& req) -> myxmr::htmlresponse
         {
            ...
            return myxmr::htmlresponse(
                    anonima.show_checkrawkeyimgs(raw_data, viewkey));
        });
    }
    ...
    if (enable_output_key_checker)
    {
        ...
        ([&]() {
            return myxmr::htmlresponse(anonima.show_rawoutputkeys());
        });
        ...
        ([&](const crow::request& req) -> myxmr::htmlresponse
         {
            ...
            return myxmr::htmlresponse(
                    anonima.show_checkcheckrawoutput(raw_data, viewkey));
        });
    }
    ...
    /**
     * @brief Mapping for the swap page
     */
    CROW_ROUTE(app, "/swap/start").methods("GET"_method)
    ([&](const crow::request& req) {
        return myxmr::htmlresponse(anonima.start_swap());
    });

    /**
     * @brief Mapping for the inital swap status page
     */
    CROW_ROUTE(app, "/swap/status").methods("GET"_method)
    ([&](const crow::request& req) {
        return myxmr::htmlresponse(
            anonima.show_status(
                remove_bad_chars(
                        string(req.url_params.get("btc_address"))),
                remove_bad_chars(
                        string(req.url_params.get("xmr_address"))),
                remove_bad_chars(
                        string(req.url_params.get("sellers")))));
    });

    CROW_ROUTE(app, "/swap/client/update/<string>")
    ([&](const string client_id) {
        return myxmr::htmlresponse(anonima.get_swap_status(client_id, true));
    });

    CROW_ROUTE(app, "/mempool")
    ([&]() {
        return myxmr::htmlresponse(anonima.mempool(true));
    });
...
//    });
    ...
    if (enable_json_api)
    {
        ...
        ([&](string tx_hash) {
            ...
            myxmr::jsonresponse r{anonima.json_transaction(remove_bad_chars(tx_hash))};
        ...
        ([&](string tx_hash) {
            ...
            myxmr::jsonresponse r{anonima.json_rawtransaction(remove_bad_chars(tx_hash))};
        ...
        ([&](string tx_hash) {
            ...
            myxmr::jsonresponse r{anonima.json_detailedtransaction(remove_bad_chars(tx_hash))};
        ...
        ([&](string block_no_or_hash) {
            ...
            myxmr::jsonresponse r{anonima.json_block(remove_bad_chars(block_no_or_hash))};
        ...
        ([&](string block_no_or_hash) {
            ...
            myxmr::jsonresponse r{anonima.json_rawblock(remove_bad_chars(block_no_or_hash))};
        ...
        ([&](const crow::request &req) {
            ...
            myxmr::jsonresponse r{anonima.json_transactions(
        ...
        ([&](const crow::request &req) {
            ...
            myxmr::jsonresponse r{anonima.json_mempool(
                    remove_bad_chars(page), remove_bad_chars(limit))};
        ...
        ([&](string search_value) {
            ...
            myxmr::jsonresponse r{anonima.json_search(remove_bad_chars(search_value))};
        ...
        ([&]() {
            ...
            myxmr::jsonresponse r{anonima.json_networkinfo()};
        ...
        ([&]() {
            ...
            myxmr::jsonresponse r{anonima.json_emission()};
        ...
        ([&](const crow::request &req) {
            ...
            myxmr::jsonresponse r{anonima.json_outputs(
                    remove_bad_chars(tx_hash),
        ...
        ([&](const crow::request &req) {
            ...
            myxmr::jsonresponse r{anonima.json_outputsblocks(
        ...
        ([&]() {
            ...
            myxmr::jsonresponse r{anonima.json_version()};
    ...
    if (enable_autorefresh_option)
    {
        ...
        ([&]() {
            uint64_t page_no {0};
            bool refresh_page {true};
            return myxmr::htmlresponse(anonima.index2(page_no, refresh_page));
        });
    }
    ...
    cout << "The board is terminating." << endl;
